...
const PrivatePolicy = () => {
  ...
  return (
    <div>
      <div className="container mt-5 mb-2 text-gray-400">
      ...
      <div className="translations-content-container">
        <div className="container">
          <div id="en" className="flex flex-col gap-y-4 mt-4">
            <h1>Privacy Policy for Transverse</h1>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to Transverse AI
                  llc, Address: 3780 Watt Way, Los Angeles, CA 90089.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Transverse , accessible
                  from{" "}
                  <a
                    href="transverse-ai.com"
            ...
            <ul>
              <li>By email: team@trasverse-ai.com</li>
            </ul>
          </div>
        </div>
      </div>
